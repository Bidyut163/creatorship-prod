                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <p>
                                        ...
                                        adipisicing elit amet cumque cupiditate
                                    </p>
                                </div>
                                <div class="col-lg-7">
                                    <div
                                ...
                                <div class="col-sm-12">
                                    <div class="text-dark">
                                        <div class="d-flex pb-3 border-bottom justify-content-between">
                                            ...
                                            <div>
                                                <h6 class="font-weight-bold text-info ml-sm-2">
                                                    $325
                                                </h6>
                                            </div>
                                        </div>
                                ...
                                <table class="table table-header-bg">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <i
                                                    class="flag-icon flag-icon-us mr-2"
                                                    title="us"
                                                    id="us"
                                                ></i>{' '}
                                                United States
                                        ...
                                        <tr>
                                            <td>
                                                <i
                                                    class="flag-icon flag-icon-at mr-2"
                                                    title="us"
                                                    id="at"
                                                ></i>{' '}
                                                Austria
                                        ...
                                        <tr>
                                            <td>
                                                <i
                                                    class="flag-icon flag-icon-fr mr-2"
                                                    title="us"
                                                    id="fr"
                                                ></i>{' '}
                                                France
                                        ...
                                        <tr>
                                            <td class="py-1">
                                                <i
                                                    class="flag-icon flag-icon-de mr-2"
                                                    title="us"
                                                    id="de"
                                                ></i>{' '}
                                                Germany
                                        ...
                                        <tr>
                                            <td class="pb-0">
                                                <i
                                                    class="flag-icon flag-icon-ae mr-2"
                                                    title="ae"
                                                    id="ae"
                                                ></i>{' '}
