...
const CreatorProfileEdit = ({
    ...
    useEffect(() => {
        ...
        setFormData({
            ...
            creatorType:
                loading || !profile.creatorType ? '' : profile.creatorType,
            address: loading || !profile.address ? '' : profile.address,
            selfDesc: loading || !profile.selfDesc ? '' : profile.selfDesc,
            helpDesc: loading || !profile.helpDesc ? '' : profile.helpDesc,
        });
