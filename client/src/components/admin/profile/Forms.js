                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-description">
                                Add classes like <code>.form-control-lg</code>{' '}
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-description">
                                Checkbox and radio controls (default appearance
                                is in primary color)
                            </p>
                            <form>
                                <div class="row">
                        ...
                        <div class="card-body">
                            <p class="card-description">
                                Add class <code>.form-check-</code> for checkbox
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-description">
                                Add class <code>.toggle-switch-</code> for
                                toggle switch controls in theme colors
                            </p>
                            <div class="form-group row">
                                <div class="col">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-description">
                                ...
                                display a series of labels, form controls, and
